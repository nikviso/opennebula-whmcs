...
$_LANG['cartdomainsconfigdesc'] = "Ниже вы можете настроить доменные имена из вашей корзины, выбрав необходимые дополнения и указав DNS сервера.";
...
$_LANG['cartnameserversdesc'] = "Если Вы хотите использовать свои DNS сервера, введите их ниже. По умолчанию для хостинга используются наши DNS сервера";
...
$_LANG['clientareacontactsemailssupport'] = "Электронные письма службы поддержки - получать копии всех обращений в службу поддержки, созданных владельцем родительской учетной записи.";
...
$_LANG['clientareamodifynameservers'] = "Изменить DNS сервера";
$_LANG['clientareamodifywhoisinfo'] = "Изменить контактную информацию в WHOIS";
$_LANG['clientareanameserver'] = "DNS сервер";
...
$_LANG['domainnameserver1'] = "DNS сервер 1";
$_LANG['domainnameserver2'] = "DNS сервер 2";
$_LANG['domainnameserver3'] = "DNS сервер 3";
$_LANG['domainnameserver4'] = "DNS сервер 4";
$_LANG['domainnameserver5'] = "DNS сервер 5";
$_LANG['domainnameservers'] = "DNS сервера";
$_LANG['domainordernow'] = "Заказать сейчас!";
$_LANG['domainorderrenew'] = "Продление домена";
$_LANG['domainprice'] = "Цена";
$_LANG['domainregisterns'] = "Регистрация DNS сервера";
$_LANG['domainregisternscurrentip'] = "Текущий IP адрес";
$_LANG['domainregisternsdel'] = "Удалить DNS сервер";
$_LANG['domainregisternsdelsuccess'] = "DNS сервер удален";
$_LANG['domainregisternsexplanation'] = "Отсюда вы можете управлять своими DNS серверами (NS1.example.com, NS2.example.com...).";
$_LANG['domainregisternsip'] = "IP адрес";
$_LANG['domainregisternsmod'] = "Изменить IP адрес DNS сервера";
$_LANG['domainregisternsmodsuccess'] = "DNS сервер изменен";
$_LANG['domainregisternsnewip'] = "Новый IP адрес";
$_LANG['domainregisternsns'] = "DNS сервер";
$_LANG['domainregisternsreg'] = "Зарегистрировать DNS сервер";
$_LANG['domainregisternsregsuccess'] = "DNS сервер зарегистрирован";
...
$_LANG['orderchangenameservers'] = "Изменить только DNS сервера";
...
$_LANG['orderdomainoption2'] = "Я обновлю DNS сервера для существующего домена или зарегистрирую новый домен.";
...
$_LANG['ordererrornameserver1'] = "Вы должны ввести DNS сервер 1";
$_LANG['ordererrornameserver2'] = "Вы должны ввести DNS сервер 2";
...
$_LANG['ordererrorservernonameservers'] = "Вы должны ввести префиксы DNS серверов";
...
$_LANG['orderservernameservers'] = "DNS сервера";
$_LANG['orderservernameserversdescription'] = "Вводимые префиксы определят DNS сервера по умолчанию, например: ns1.example.com и ns2.example.com";
...
$_LANG['cartdomainunavailablemanual'] = "Я являюсь владельцем этого домена и обновлю DNS сервера";
...
$_LANG['cartnameserverchoice'] = "Выбрать DNS сервера";
$_LANG['cartnameserverchoicedefault'] = "Использовать DNS сервера для нашего хостинга по умолчанию";
$_LANG['cartnameserverchoicecustom'] = "Использовать свои DNS сервера";
...
$_LANG['cartexistingdomainchoice'] = "Я буду использовать свой домен и обновлю его DNS сервера";
...
$_LANG['nschoicedefault'] = "Использовать DNS сервера по умолчанию";
$_LANG['nschoicecustom'] = "Использовать собственные DNS сервера (введите ниже)";
...
$_LANG['domainmanagens'] = "Управление DNS серверами";
...
$_LANG['navemailssent'] = "Отправленные письма";
...
$_LANG['changenameservers'] = "Изменить DNS сервера";
...
$_LANG['domainaddonsemailforwardinginfo'] = "Включить переадресацию почты.<br><br><br>";
...
$_LANG['newslettersubscribed'] = "Вы успешно подписались на нашу рассылку.";
$_LANG['emailMarketingAlreadyOptedIn'] = "Вы уже подписаны на нашу рассылку.";
$_LANG['emailMarketingAlreadyOptedOut'] = "Вы уже отказались от подписки на нашу рассылку.";
...
$_LANG['domaincontactdetails']['Full Name'] = "Имя, Фамилия";
$_LANG['domaincontactdetails']['Contact Name'] = "Контактное имя";
$_LANG['domaincontactdetails']['Email'] = "Email";
$_LANG['domaincontactdetails']['Email Address'] = "Адрес электронной почты";
...
$_LANG['domaincontactdetails']['Fax Number'] = "Номер факса";
...
$_LANG['domainprivatenameservers'] = "Приватные DNS";
...
$_LANG['orderForm']['authCodeTooltip'] = "Чтобы начать перенос вам необходимо получить код домена у текущего регистратора. Их часто называют кодом epp или кодом авторизации. Они действуют как пароль и уникальны для доменного имени.";
...
$_LANG['filemanagement']['invalidname'] = "Допустимые имена файлов содержат только буквенно-цифровые символы, точки, дефис и символы подчеркивания.";
...
$_LANG['filemanagement']['checkAvailableDiskSpace'] = "Пожалуйста, проверьте доступное место на диске.";
...
$_LANG['clientareatransferredaway'] = "Передано";
$_LANG['clientareacompleted'] = "Завершено";
$_LANG['domainContactUs'] = "Свяжитесь с нами";
...
$_LANG['pricing']['transfer'] = "Перевод";
$_LANG['pricing']['renewal'] = "Продление";
$_LANG['pricing']['selectExtCategory'] = "Пожалуйста, выберите категорию из предложенных.";
...
$_LANG['errorPage']['404']['title'] = "Oпа!";
$_LANG['errorPage']['404']['subtitle'] = "Мы не смогли найти эту страницу";
$_LANG['errorPage']['404']['description'] = "Пожалуйста, попробуйте использовать параметры ниже.";
$_LANG['errorPage']['404']['home'] = "Домой";
$_LANG['errorPage']['404']['submitTicket'] = "Связаться с службой поддержки";
...
$_LANG['emailMarketing']['joinOurMailingList'] = "Присоединиться к нашему списку рассылки";
...
$_LANG['sslState']['sslInactive'] = "SSL не обнаружен. Нажмите здесь, чтобы просмотреть параметры SSL";
$_LANG['sslState']['sslActive'] = "Обнаружен действительный SSL. Истекает: :expiry";
$_LANG['sslState']['sslUnknown'] = "Невозможно проверить статус SSL";
$_LANG['sslState']['validSsl'] = "Обнаружен действительный SSL";
$_LANG['sslState']['noSsl'] = "SSL не обнаружен";
$_LANG['sslState']['sslInactiveService'] = "Сервис неактивен";
...
$_LANG['generatePassword']['lengthValidationError'] = "Введите длину пароля от 8 до 64";
$_LANG['generatePassword']['pwLength'] = "Длина пароля";
$_LANG['generatePassword']['generatedPw'] = "Сгенерировать пароль";
...
$_LANG['emailPreferences']['affiliate'] = "Партнерские электронные письма - получение партнерских уведомлений.";
$_LANG['emailPreferences']['domain'] = "Электронная почта домена - подтверждение регистрации/переноса, уведомления о продлении.";
$_LANG['emailPreferences']['general'] = "Общие электронные письма - все электронные письма, связанные с аккаунтом.";
$_LANG['emailPreferences']['invoice'] = "Электронные письма со счетами - новые счета, напоминания, просроченные уведомления.";
$_LANG['emailPreferences']['product'] = "Электронные письма о продуктах - приветственные письма, уведомления о приостановке и другие уведомления о жизненном цикле продукта.";
$_LANG['emailPreferences']['support'] = "Электронные письма службы поддержки - получать копии всех сообщений службы поддержки.";
...
$_LANG['emailPreferences']['oneRequired'] = "У вас должен быть включен хотя бы один адрес электронной почты, чтобы получать уведомления, связанные с доменом, в соответствии с требованиями ICANN.";
$_LANG['emailPreferences']['domainContactRequired'] = "Чтобы отключить уведомления домена, включите уведомления домена для основного владельца учетной записи или другого контакта.";
$_LANG['emailPreferences']['domainClientRequired'] = "Чтобы отключить уведомления домена, создайте альтернативный контакт, который будет их получать.";
...
$_LANG['userManagement']['managePermissions'] = "Управление правами доступа";
$_LANG['userManagement']['permissions'] = "Права доступа";
$_LANG['userManagement']['usersFound'] = ":count Пользователей найдено";
$_LANG['userManagement']['userDescriptor'] = "Адрес электронной почты / последний вход";
$_LANG['userManagement']['lastLogin'] = "Последний вход";
$_LANG['userManagement']['actions'] = "Действие";
...
$_LANG['userManagement']['inviteEmail'] = "Пригласительное письмо";
$_LANG['userManagement']['inviteNewUserDescription'] = "Приглашение нового пользователя позволяет вам пригласить нового пользователя в свою учетную запись. Если у приглашенного уже есть существующая учетная запись пользователя, он сможет получить доступ к вашей учетной записи, используя свои существующие учетные данные для входа. Если у пользователя еще нет учетной записи пользователя , он сможет его создать.";
$_LANG['userManagement']['allPermissions'] = "Разрешить всё";
$_LANG['userManagement']['choosePermissions'] = "Выбрать права доступа";
$_LANG['userManagement']['sendInvite'] = "Отправить приглашение";
$_LANG['userManagement']['removeAccessSure'] = "Вы уверены, что хотите запретить этому пользователю доступ?";
$_LANG['userManagement']['removeAccessInfo'] = "Он больше не сможет получить доступ к этой учетной записи или управлять ею.";
...
$_LANG['userManagement']['permissionsUpdateSuccess'] = "Права доступа успешно обновлены!";
...
$_LANG['userManagement']['inviteResendSuccess'] = "Приглашение отправлено повторно!";
$_LANG['userManagement']['inviteCancelled'] = "Приглашение успешно отменено!";
$_LANG['userManagement']['settings'] = "К вашей учетной записи применяются следующие параметры безопасности.";

$_LANG['userProfile']['profile'] = "Профиль";
$_LANG['userProfile']['changeEmail'] = "Изменить адрес электронной почты";
$_LANG['userProfile']['notVerified'] = "Электронная почта не проверена";
$_LANG['userProfile']['verified'] = "Почта проверена";

$_LANG['accountInvite']['title'] = "Принять приглашение";
$_LANG['accountInvite']['youHaveBeenInvited'] = "Вас пригласили в :clientName";
$_LANG['accountInvite']['givenAccess'] = ":ot:senderName:ct предоставил вам доступ к :ot:clientName:ct account.";
...
$_LANG['accountInvite']['acceptSuccess'] = "Приглашение к аккаунту принято!";
$_LANG['accountInvite']['emailAlreadyExists'] = "Пользователь с этим адресом электронной почты уже существует. Пожалуйста, войдите или используйте другой адрес электронной почты.";
$_LANG['accountInvite']['notFound'] = "К сожалению, мы не смогли найти ожидающее приглашение, соответствующее вашему запросу.";
$_LANG['accountInvite']['contactAdministrator'] = "Обратитесь к администратору аккаунта, чтобы запросить новое приглашение.";
...
$_LANG['permissions']['descriptions']['productsso'] = "Разрешить единый вход в службы";
$_LANG['permissions']['descriptions']['domains'] = "Просмотр доступа к регистрации доменов";
$_LANG['permissions']['descriptions']['managedomains'] = "Разрешить управление доменом, например серверы имен/whois/переводы";
$_LANG['permissions']['descriptions']['invoices'] = "Доступ к просмотру и оплате счетов";
$_LANG['permissions']['descriptions']['quotes'] = "Права доступа на просмотр и принятие предложений/оценок";
$_LANG['permissions']['descriptions']['tickets'] = "Доступ для открытия, чтения и управления тикетами службы поддержки";
$_LANG['permissions']['descriptions']['affiliates'] = "Доступ для просмотра и запроса вывода средств";
$_LANG['permissions']['descriptions']['emails'] = "Доступ для просмотра истории электронной почты аккаунта";
$_LANG['permissions']['descriptions']['orders'] = "Разрешить размещение новых заказов";

$_LANG['closed'] = "Закрыт";
$_LANG['noPermission'] = "Отсутствуют права доступа";

$_LANG['domainDetails']['error']['getNs'] = "Возникла проблема при получении серверов имен доменов. Обратитесь в службу поддержки.";
$_LANG['domainDetails']['error']['saveNs'] = "Возникла проблема при обновлении серверов доменных имен. Обратитесь в службу поддержки.";
$_LANG['domainDetails']['error']['getContact'] = "При получении контактных данных домена возникла проблема. Обратитесь в службу поддержки.";
...
$_LANG['domainDetails']['error']['getDns'] = "Возникла проблема при получении записей DNS. Обратитесь в службу поддержки.";
$_LANG['domainDetails']['error']['saveDns'] = "Возникла проблема при обновлении записей DNS. Обратитесь в службу поддержки.";
$_LANG['domainDetails']['error']['getEmailFwd'] = "Возникла проблема при получении серверов пересылки электронной почты. Обратитесь в службу поддержки.";
...
$_LANG['domainDetails']['error']['deleteNs'] = "Возникла проблема при удалении частного сервера имен. Обратитесь в службу поддержки.";
$_LANG['domainDetails']['error']['modifyNs'] = "Возникла проблема при изменении частного сервера имен. Обратитесь в службу поддержки.";
$_LANG['domainDetails']['error']['registerNs'] = "Возникла проблема при регистрации частного сервера имен. Обратитесь в службу поддержки.";
...
$_LANG['domainDetails']['error']['releaseDomain'] = "При освобождении домена возникла проблема. Обратитесь в службу поддержки.";
$_LANG['domainDetails']['error']['resendNotification'] = "При повторной отправке уведомления по электронной почте возникла проблема. Обратитесь в службу поддержки.";
...
$_LANG['cart']['selectIdnLanguageForRegister'] = "Пожалуйста, выберите язык домена, который вы хотите зарегистрировать.";
...
$_LANG['lang'] = "ru";
$_LANG['vps_text'] = "Виртуальный сервер";
$_LANG['vps_url'] = "virtualny-server";
$_LANG['serverrental_text'] = "Аренда сервера";
$_LANG['serverrental_url'] = "arenda-servera";
$_LANG['domainname_text'] = "Доменное имя";
//
$_LANG['emailMarketing']['optInMessage'] = "Время от времени мы хотели бы присылать вам новости, информацию и специальные предложения по электронной почте. Чтобы присоединиться к нашему списку рассылки, просто отметьте поле ниже. Вы можете отписаться в любое время.";
$_LANG['domainTldCategory']['Popular'] = "Популярные";
$_LANG['domainTldCategory']['Other'] = "Другие";
$_LANG['vmclientareastatus'] = "Статус VPS";
$_LANG['rebootvps'] = "Перегрузить";
$_LANG['poweroffvps'] = "Выключить";
$_LANG['resumevps'] = "Включить";
$_LANG['vpsmanagement'] = "Управление VPS";
$_LANG['backtooverview'] = "Вернуться к обзору продукта";
$_LANG['poweroffwarning'] = "Вы действительно хотите выключить VPS?";
$_LANG['rebootwarning'] = "Вы действительно хотите перегрузить VPS?";
$_LANG['closewarning'] = "Закрыть";
$_LANG['proceedwarning'] = "Продолжить";
$_LANG['titlevmwarning'] = "ВНИМАНИЕ";
$_LANG['vmstatepoweroff'] = "ВЫКЛЮЧЕН";
$_LANG['vmstateactive'] = "АКТИВЕН";
$_LANG['vmstateunknown'] = "НЕИЗВЕСТНО";
$_LANG['vmostype'] = 'Тип ОС';
$_LANG['vmname'] = 'Имя VPS';
$_LANG['vmipaddress'] = 'ИП адрес VPS';
$_LANG['vmstateerror'] = "Опа! Что-то пошло не так!";
$_LANG['footerContactUs'] = "Наши контакты";
$_LANG['footerInformation'] = "Информация";
$_LANG['footerInformation'] = "Информация";
$_LANG['footerLegalAddress'] = "Юридический адрес:";
$_LANG['footerPhone'] = "Телефон:";
$_LANG['footerRegNr'] = "Номер регистрации:";
$_LANG['footerToS'] = "Условия предоставления услуг";
$_LANG['privacypolicy'] = "Политики конфиденциальности";
$_LANG['privacypolicyreg'] = "Политикa конфиденциальности";
$_LANG['orderppagreement'] = "Я ознакомился и принимаю условия";
$_LANG['orderppagreementmastconfirm'] = "Вы должны подтвердить свое согласие с 'Политикой конфиденциальности'";
$_LANG['footersupportmail'] = "Написать в службу поддержки";
$_LANG['footerabusemail'] = "Сообщить о нарушении";
//$_LANG['registrationnumber'] = "Регистрационный номер/Персональный код";
$_LANG['registrationnumber'] = "Регистрационный номер";
$_LANG['personalcode'] = "Персональный код";
$_LANG['registrationnumbervalid'] = "Необходимо корректно ввести регистрационный номер организации";
$_LANG['personalcodevalid'] = "Необходимо корректно ввести персональный код";
$_LANG['domaincontactdetails']['Registration number/Personal code'] = "Регистрационный номер/Персональный код";
$_LANG['notfound'] = 'Не найден.';
